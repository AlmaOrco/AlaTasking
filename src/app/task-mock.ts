...
export const TASKS: Task[] = [
  ...
  { id: 7, title: 'Dar funcionalidad a los botones de detalles' },
  { id: 8, title: 'Intentar meter la selection list de material' },
  { id: 9, title: 'Distinguir la funcionalidad de click y change' },
